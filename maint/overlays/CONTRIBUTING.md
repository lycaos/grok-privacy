# Contributing to Grok Privacy

Thanks for helping improve **Grok Privacy** — the VSCodium-style community
...
1. Read [`PRIVACY.md`](PRIVACY.md). Grok Privacy hard-disables vendor research
...
2. Search [existing issues](https://github.com/lycaos/grok-privacy/issues)
...
cargo run -p xai-grok-pager-bin          # launches the TUI binary `grok`
```
...
privacy crates and the `grok` binary.
...
Grok Privacy periodically tracks
...
- Re-apply Grok Privacy privacy/branding deltas if upstream reintroduces tracking
