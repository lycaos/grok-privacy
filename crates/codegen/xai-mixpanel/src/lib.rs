...
#[allow(dead_code)] // unused: privacy no-op track/engage paths never send requests
...
impl Mixpanel {
    ...
    ///
    /// Not called by [`Self::track`] in Grok Privacy (track is a hard no-op),
    ...
    ///
    /// **Grok Privacy:** always a no-op — product analytics never leave the host.
    pub async fn track(
        &self,
        _event: &str,
