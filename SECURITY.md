...
## Reporting a vulnerability in Grok Privacy
...
1. **GitHub private vulnerability reporting** on
   [lycaos/grok-privacy](https://github.com/lycaos/grok-privacy/security)
...
- Impact assessment
- Whether the issue is in Grok Privacy-specific deltas (privacy/branding) or
...
- **In scope:** Grok Privacy client code in this repository, packaging, and
